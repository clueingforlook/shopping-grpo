"""Deterministic, outcome-only evaluation for the frozen WLX Final-200."""
...
WLX_EVAL_V3_TASK_SCHEMA = "wlx-eval-v3-task-result-v1"
WLX_EVAL_V3_SUMMARY_SCHEMA = "wlx-eval-v3-summary-v1"
WLX_EVAL_V3_MANIFEST_SCHEMA = "wlx-eval-v3-manifest-v1"
...
def evaluate_trajectory(
    ...
    *,
    ...
    return {
        "schema_version": WLX_EVAL_V3_TASK_SCHEMA,
        "task_id": task_id,
...
def summarize(
    ...
    *,
    ...
    for record in records:
        if record.get("schema_version") != WLX_EVAL_V3_TASK_SCHEMA:
    ...
    return {
        "schema_version": WLX_EVAL_V3_SUMMARY_SCHEMA,
...
def run_offline_evaluation(
    *,
    ...
    if limit is None and file_sha256(tasks_path) != EXPECTED_FINAL200_SHA256:
        raise ValueError("formal Eval v3 must use the frozen WLX Final-200 task file")
    ...
    manifest = {
        "schema_version": WLX_EVAL_V3_MANIFEST_SCHEMA,
        ...
        "sources": sources,
        "outputs": {
            "task_results": "wlx-eval-v3-task-results.jsonl",
            "summary_json": "wlx-eval-v3-summary.json",
            "summary_markdown": "wlx-eval-v3-summary.md",
        },
    }
    output_dir.mkdir(parents=True, exist_ok=True)
    paths = {
        "task_results": output_dir / "wlx-eval-v3-task-results.jsonl",
        "summary_json": output_dir / "wlx-eval-v3-summary.json",
        "summary_markdown": output_dir / "wlx-eval-v3-summary.md",
        "manifest": output_dir / "wlx-eval-v3-manifest.json",
    }
...
__all__ = [
    ...
    "WLX_EVAL_V3_MANIFEST_SCHEMA",
    "WLX_EVAL_V3_SUMMARY_SCHEMA",
    "WLX_EVAL_V3_TASK_SCHEMA",
    "evaluate_trajectory",
    "file_sha256",
    "load_task_ids",
    "render_markdown",
