"""Reward v4: deterministic outcome and process signals for ShopSimulator."""
...
REWARD_VERSION = "wlx-reward-v4"
PRM_SELECTION_MARKER = 1.0e-4
...
def compute_orm(state: Mapping[str, Any]) -> dict[str, Any]:
...
def _result(
    *,
    ...
    if not math.isfinite(score):
        raise ValueError("ORM score must be finite")
    return {
...
def compute_prm(state: Mapping[str, Any]) -> dict[str, Any]:
