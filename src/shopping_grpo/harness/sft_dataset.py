...
from shopping_grpo.harness.contracts import ToolCall
...
from shopping_grpo.harness.sft_contracts import (
    SftDisposition,
    SFT_PIPELINE_VERSION,
)
from shopping_grpo.harness.sft_metrics import (
    TrainingSequenceUnrenderable,
    TrainingTokenCounter,
    measure_training_length,
    trajectory_cost_metrics,
)
from shopping_grpo.harness.sft_outcomes import (
    classify_attempt,
...
SFT_DATASET_VERSION = "wlx-sft-dataset-v1"
...
def build_dataset_artifacts(
    *,
    ...
    summary = {
        "dataset_version": SFT_DATASET_VERSION,
        "pipeline_version": SFT_PIPELINE_VERSION,
        "raw_rows": total,
