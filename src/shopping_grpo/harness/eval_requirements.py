...
from shopping_grpo.harness.eval_contracts import REQUIREMENT_STATUSES
from shopping_grpo.harness.eval_rubric import validate_rubric_bundle


EVAL_REQUIREMENTS_VERSION = "wlx-eval-v2-requirements-v1"
...
def evaluate_frozen_requirements(
    ...
    *,
    ...
    return {
        "version": EVAL_REQUIREMENTS_VERSION,
