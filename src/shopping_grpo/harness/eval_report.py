"""Eval v2 的单 Run 汇总、成对比较与 Markdown 报告。"""
...
from shopping_grpo.harness.eval_contracts import EVAL_REPORT_VERSION
...
def render_summary_markdown(summary: Mapping[str, Any]) -> str:
    ...
    lines = [
        f"# Eval Run：{summary.get('run_name') or 'unnamed'}",
        "",
        ...
        f"- 购买正确：{_ratio_text(outcome.get('purchase_correct'))}",
        (
            "- 可直接评价任务中的 购买正确："
