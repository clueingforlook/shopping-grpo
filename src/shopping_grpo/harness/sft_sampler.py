...
from shopping_grpo.harness.sft_metrics import aggregate_token_metrics
from shopping_grpo.harness.sft_outcomes import (
    classify_attempt,
    is_strict_gold,
    trajectory_mapping,
)
from shopping_grpo.harness.sft_storage import RawTrajectoryStore
...
class CoreAttemptExecutor:
    """把 SFT 调度器接到 EpisodeRunner，而不是原项目采样 Harness。"""
