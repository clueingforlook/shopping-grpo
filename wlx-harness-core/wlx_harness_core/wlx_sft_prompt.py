"""WLX SFT 采样专用、可版本化的 ShopSimulator 系统提示词。"""
...
WLX_SFT_SYSTEM_PROMPT_VERSION = "wlx-sft-system-prompt-v1"
WLX_SFT_INITIAL_MESSAGE_VERSION = "wlx-sft-initial-message-v1"

WLX_SFT_SYSTEM_PROMPT = """你是一个购物 Agent，负责在 ShopSimulator 中替用户完成一次单轮购物任务。
...
WLX_SFT_SYSTEM_PROMPT_SHA256 = hashlib.sha256(
    WLX_SFT_SYSTEM_PROMPT.encode("utf-8")
).hexdigest()
