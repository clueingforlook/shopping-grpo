"""WLX 用户需求 Rubric 的冻结契约；本模块不从隐藏目标补充需求。"""
...
WLX_EVAL_RUBRIC_VERSION = "wlx-eval-rubric-v1"
...
def freeze_rubric_bundle(
    *,
    ...
    return {
        "schema_version": WLX_EVAL_RUBRIC_VERSION,
...
def validate_rubric_bundle(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if value.get("schema_version") != WLX_EVAL_RUBRIC_VERSION:
