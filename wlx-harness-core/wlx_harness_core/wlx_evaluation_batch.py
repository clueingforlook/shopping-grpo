...
from wlx_harness_core.wlx_sft_storage import append_jsonl_row, read_jsonl
from wlx_harness_core.wlx_trajectory_evaluator import evaluate_trajectory


WLX_EVALUATION_BATCH_VERSION = "wlx-evaluation-batch-v1"
WLX_EVALUATION_MANIFEST_VERSION = "wlx-evaluation-run-manifest-v1"
...
class EvaluationBatchPaths:
    ...
    def __init__(self, output_dir: str | Path) -> None:
        ...
        self.trajectories = self.output_dir / "wlx-trajectories.jsonl"
        self.task_results = self.output_dir / "wlx-task-results.jsonl"
        self.manifest = self.output_dir / "wlx-run-manifest.json"
...
async def run_evaluation_batch(
    *,
            ...
            try:
                ...
                trajectory = await runner.run(
                    EpisodeRequest(
                        ...
                        attempt_index=0,
                        metadata={
                            "evaluation_batch_version": WLX_EVALUATION_BATCH_VERSION,
    ...
    return {
        "batch_version": WLX_EVALUATION_BATCH_VERSION,
...
def _prepare_manifest(
    ...
    if paths.manifest.exists():
        ...
        if (
            existing.get("schema_version") != WLX_EVALUATION_MANIFEST_VERSION
    ...
    manifest = {
        "schema_version": WLX_EVALUATION_MANIFEST_VERSION,
...
__all__ = [
    ...
    "WLX_EVALUATION_BATCH_VERSION",
    "WLX_EVALUATION_MANIFEST_VERSION",
