"""WLX Rubric 的规则预提取、DeepSeek 生成和确定性审计。"""
...
WLX_RUBRIC_PROMPT_VERSION = "wlx-rubric-prompt-v1"
WLX_RUBRIC_GENERATOR_VERSION = "wlx-rubric-generator-v1"
WLX_RUBRIC_RULES_VERSION = "wlx-rubric-rules-v1"
...
def extract_rule_signals(instruction: str) -> dict[str, Any]:
    ...
    return {
        "rules_version": WLX_RUBRIC_RULES_VERSION,
...
Prompt 版本：{WLX_RUBRIC_PROMPT_VERSION}"""


WLX_RUBRIC_SYSTEM_PROMPT = _rubric_system_prompt()
WLX_RUBRIC_SYSTEM_PROMPT_SHA256 = hashlib.sha256(
    WLX_RUBRIC_SYSTEM_PROMPT.encode("utf-8")
).hexdigest()
...
def build_rubric_messages(
    ...
    return [
        {"role": "system", "content": WLX_RUBRIC_SYSTEM_PROMPT},
...
__all__ = [
    ...
    "WLX_RUBRIC_RULES_VERSION",
    "WLX_RUBRIC_SYSTEM_PROMPT",
