"""WLX 购买结果验证器：只比较用户需求与实际购买，不读取 Reward v3。"""
...
WLX_PURCHASE_VERIFIER_VERSION = "wlx-purchase-verifier-v2"
...
class PurchaseVerification:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            "verifier_version": WLX_PURCHASE_VERIFIER_VERSION,
...
def requirements_from_environment_goal(
    ...
    """ShopSimulator goal 转成 WLX 需求契约。
...
def verify_environment_terminal(
    ...
    """ShopSimulator 终局字典中取 goal/purchase 并执行 WLX 验证。"""
