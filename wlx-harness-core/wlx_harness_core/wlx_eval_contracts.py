"""WLX Eval v2 的稳定枚举、Schema 版本和轻量校验。"""
...
WLX_EVAL_SCHEMA_VERSION = "wlx-eval-v2"
WLX_EVAL_METHOD_VERSION = "wlx-eval-v2"
WLX_EVAL_EVENT_VERSION = "wlx-eval-events-v1"
WLX_EVAL_ELIGIBILITY_VERSION = "wlx-eval-eligibility-v1"
WLX_EVAL_OUTCOME_VERSION = "wlx-eval-outcome-v1"
WLX_EVAL_BEHAVIOR_VERSION = "wlx-eval-behavior-v1"
WLX_EVAL_ATTRIBUTION_VERSION = "wlx-eval-attribution-v1"
WLX_EVAL_REPORT_VERSION = "wlx-eval-report-v1"
WLX_EVAL_OFFLINE_RUN_VERSION = "wlx-offline-evaluation-v1"
...
def validate_evaluation_record(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if row.get("schema_version") != WLX_EVAL_SCHEMA_VERSION:
        raise EvalContractError("unexpected WLX Eval schema_version")
...
__all__ = [
    ...
    "REVIEW_REQUIRED",
    "UNDETERMINED_RESPONSIBILITY",
    "WLX_EVAL_ATTRIBUTION_VERSION",
    "WLX_EVAL_BEHAVIOR_VERSION",
    "WLX_EVAL_ELIGIBILITY_VERSION",
    "WLX_EVAL_EVENT_VERSION",
    "WLX_EVAL_METHOD_VERSION",
    "WLX_EVAL_OFFLINE_RUN_VERSION",
    "WLX_EVAL_OUTCOME_VERSION",
    "WLX_EVAL_REPORT_VERSION",
