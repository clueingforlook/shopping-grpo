#!/usr/bin/env python3
"""把多批 WLX raw 派生成统一使用最终难度标签的单一构建输入。"""
...
OUTPUT_RAW_NAME = "wlx-merged-raw-v3.jsonl"
OUTPUT_MANIFEST_NAME = "wlx-merge-manifest.json"
...
def prepare_final_input(
    *,
    ...
    temporary_raw = output_dir / f"{OUTPUT_RAW_NAME}.wlx_tmp"
    temporary_manifest = output_dir / f"{OUTPUT_MANIFEST_NAME}.wlx_tmp"
