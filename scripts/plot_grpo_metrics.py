#!/usr/bin/env python3
"""Parse a GRPO log and render dependency-free SVG training curves."""
...
def render_svg(
    ...
    *,
    ...
    elements = [
        ...
        '<text x="40" y="38" class="title">GRPO training curves</text>',
...
def main() -> None:
    ...
    output_dir = args.output_dir or args.log.parent / "training-plots"
    ...
    metrics_path = output_dir / f"training-metrics{suffix}.csv"
    validation_path = output_dir / f"validation-metrics{suffix}.csv"
    curves_path = output_dir / f"training-curves{suffix}.svg"
    summary_path = output_dir / f"training-curve-summary{suffix}.json"
