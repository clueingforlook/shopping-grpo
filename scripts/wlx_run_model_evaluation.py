#!/usr/bin/env python3
"""用一个已启动的 Base、SFT 或 GRPO 模型执行 WLX 逐题评测批次。"""
...
from wlx_harness_core.wlx_contracts import ENVIRONMENT_VERSION  # noqa: E402
from wlx_harness_core.wlx_evaluation_batch import (  # noqa: E402
    EvaluationBatchSafetyPause,
    run_evaluation_batch,
)
from wlx_harness_core.wlx_purchase_verifier import (  # noqa: E402
    WLX_PURCHASE_VERIFIER_VERSION,
)
...
from wlx_harness_core.wlx_sft_storage import file_sha256, read_jsonl  # noqa: E402
from wlx_harness_core.wlx_sft_tokenizer import (  # noqa: E402
    TransformersRuntimeTokenCounter,
    WLX_TRANSFORMERS_RUNTIME_COUNTER_VERSION,
)
from wlx_harness_core.wlx_tools import WLX_SFT_TOOL_REGISTRY  # noqa: E402
from wlx_harness_core.wlx_trajectory_evaluator import (  # noqa: E402
...
async def run_from_args(args: argparse.Namespace) -> dict[str, Any]:
    ...
    run_contract = {
        ...
        "tokenizer": {
            ...
            "runtime_contract_version": WLX_TRANSFORMERS_RUNTIME_COUNTER_VERSION,
        },
        "generation": {
            "temperature": 0.0,
            "top_p": 1.0,
        ...
        "trajectory_evaluator_version": WLX_TRAJECTORY_EVALUATION_VERSION,
        "purchase_verifier_version": WLX_PURCHASE_VERIFIER_VERSION,
    ...
    def update_progress(snapshot: Mapping[str, Any]) -> None:
        ...
        if progress_bar is None:
            progress_bar = tqdm(
                ...
                desc=f"WLX {args.model_role.upper()}",
                unit="task",
                dynamic_ncols=True,
            )
        else:
