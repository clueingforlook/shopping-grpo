#!/usr/bin/env python3
"""Build deterministic, public-only calibration and formal sampling plans.
...
from shopping_grpo.harness.sft_contracts import SftTask  # noqa: E402
...
def materialize_features(args: argparse.Namespace) -> int:
    ...
    public_path = output_dir / "public-train-tasks.jsonl"
    ...
    features_path = output_dir / "difficulty-features.jsonl"
    ...
    stats_path = output_dir / "difficulty-stats.json"
