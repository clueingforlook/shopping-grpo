#!/usr/bin/env python3
"""按 task_id 对齐两个 WLX Eval v2 Run 并生成成对比较。"""
...
from wlx_harness_core.wlx_eval_report import (  # noqa: E402
...
def compare_from_args(args: argparse.Namespace) -> dict:
    ...
    outputs = {
        "summary_json": args.output_dir / "wlx-comparison-summary.json",
        "summary_markdown": args.output_dir / "wlx-comparison-summary.md",
        "paired_results": args.output_dir / "wlx-paired-task-results.jsonl",
    }
