...
from wlx_harness_core.wlx_eval_judge_pipeline import load_judge_cases  # noqa: E402
...
SOURCE_LABELS = EVALUATION / "wlx-judge-gold-v4" / "wlx-judge-gold-labels-frozen.jsonl"
SOURCE_MANIFEST = EVALUATION / "wlx-judge-gold-v4" / "wlx-judge-gold-manifest.json"
RUBRICS = EVALUATION / "wlx-eval200-rubrics-v1" / "wlx-rubrics.jsonl"
OUTPUT = EVALUATION / "wlx-judge-gold-v6-eval-v2"
...
def main() -> None:
    paths = {
        "labels": OUTPUT / "wlx-judge-gold-labels-frozen.jsonl",
        "manifest": OUTPUT / "wlx-judge-gold-frozen-manifest.json",
        "review": OUTPUT / "wlx-judge-gold-eval-v2-review.md",
    }
    ...
    trajectory_paths = {
        "base": EVALUATION / "wlx-base-final200-v2" / "wlx-trajectories.jsonl",
        "sft": EVALUATION / "wlx-sft-final200-v2" / "wlx-trajectories.jsonl",
    }
    cases = {}
    ...
    lines = [
        ...
        f"- Judge Prompt：`{WLX_EVAL_JUDGE_PROMPT_VERSION}`",
        "",
        "## 过程分修正",
        "",
        "| 轨迹 | 维度 | 原分 | 新分 | 原因 |",
