#!/usr/bin/env python3
"""使用规则与 DeepSeek 为 Eval 任务生成、复核并冻结 Rubric。"""
...
from shopping_grpo.harness.sft_storage import file_sha256  # noqa: E402
...
def _load_api_key(path: Path | None) -> tuple[str, str]:
    ...
    raise SystemExit(
        ...
        "DEEPSEEK_API_KEY_FILE/--api-key-file 提供权限为600的文件"
    )
