#!/usr/bin/env python3
"""Run or offline-score one Base, SFT, or GRPO model with WLX Eval v3."""
...
from scripts import wlx_run_model_evaluation  # noqa: E402
from shopping_grpo.evaluation.wlx_eval_v3 import (  # noqa: E402
...
DEFAULT_DIFFICULTY = (
    REPOSITORY
    / "outputs/wlx-evaluation-difficulty-v1/wlx-evaluation-difficulty.jsonl"
)
...
async def _run(args: argparse.Namespace) -> dict:
    if args.limit is None and file_sha256(args.tasks) != EXPECTED_FINAL200_SHA256:
        raise ValueError("正式 Eval v3 必须使用冻结的 WLX Final-200 任务文件")
    ...
    batch = await wlx_run_model_evaluation.run_from_args(collection_args)
