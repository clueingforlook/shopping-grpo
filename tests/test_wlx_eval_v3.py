"""CPU-only checks for deterministic WLX Eval v3."""
...
from shopping_grpo.evaluation.wlx_eval_v3 import (
    evaluate_trajectory,
...
class WlxEvalV3Test(unittest.TestCase):
    ...
    def test_offline_run_writes_prefixed_outputs_and_is_reusable(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertTrue((output / "wlx-eval-v3-manifest.json").is_file())
            self.assertTrue((output / "wlx-eval-v3-task-results.jsonl").is_file())
            self.assertTrue((output / "wlx-eval-v3-summary.md").is_file())
