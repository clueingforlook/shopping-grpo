"""Token-level credit assignment tests for WLX Step-GRPO."""

import numpy as np
import torch

from shopping_grpo.training.grpo.wlx_step_grpo import compute_wlx_step_advantage
...
def test_group_orm_is_broadcast_only_to_model_tokens():
    ...
    advantage, returns = compute_wlx_step_advantage(
...
def test_wrong_option_floor_applies_only_to_its_step_span():
    ...
    advantage, _ = compute_wlx_step_advantage(
